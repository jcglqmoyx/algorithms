...
class Solution {
    ...
    static bool check1(int x, int y) {
        return ((x == 1 || x == 2) && (y == 1 || y == 2)) || (x == 3 && y == 2);
    }

    static bool check2(int x, int y) {
        return (x == 1 && (y == 2 || y == 3)) || ((x == 2 || x == 3) && y == 1);
    }

    static bool check(int s0, int s1, int s2, int s3) {
...
public:
    int trafficCommand(vector<string> &directions) {
        const int n0 = (int) directions[0].size();
        const int n1 = (int) directions[1].size();
        const int n2 = (int) directions[2].size();
        const int n3 = (int) directions[3].size();
